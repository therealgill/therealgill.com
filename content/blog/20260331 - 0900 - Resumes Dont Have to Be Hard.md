---
title: "Resumes Don't Have to Be Hard!"
slug: "resumes-dont-have-to-be-hard"
date: 2026-03-31
categories: 
  - "Resume"
  - "Business"
...
1. Happily work
2. Have desire to leave, get promoted, or change job
3. Resume required!
4. Dig through Documents/NAS/Backups/Cloud Drives...
5. Realize that the .docx I made years ago has been lost to time...
6. Be grumpy
7. Make another `Gill_Resume(20XX).docx`
8. Hate making it...
9. Realize that Microsoft Word is bad, or that I am bad at using it...
10. Generate something worth submitting
11. Get the new job/promotion
12. Promise that I will keep the resume up-to-date from now on.
...
I attended the PowerShell & DevOps Global Summit in 2025. During the 'lightning demo' portion [Gilbert Sanchez](https://gilbertsanchez.com/) gave a short presentation about [Resume-as-Code](https://gilbertsanchez.com/posts/rac-resume-as-code/). His demo consisted of a quick walkthrough of [JSON Resume](https://jsonresume.org/). Wow! 

I had tried using something similar in the past. [Reactive Resume](https://rxresu.me/) was a cool project that I spent more time on the self-hosting side than the actual resume-building side. It included a ton of features, but at the time (2023? Maybe 2024...) I didn't have the capacity to rebuild my entire resume.

I recently changed job roles in my organization. I thought it would be nice to update my resume, but the only version I could find was at least three years old and in PDF format. Not terribly out of date, but not easily editable. It is 2026 and in walks ChatGPT... I revisited JSON Resume, had ChatGPT take the 2023 resume and convert it into the appropriate format, uploaded it to Github, and in a staggeringly short amount of time... [I had a resume!](https://registry.jsonresume.org/therealgill) One that I could update and track in source control. One that can easily be transformed using themes. One that I can instantly share with anyone interested about me. 
